...
def generate_meta_content(page_name, main_keywords, url):
    try:
        ...
        2. Meta Description: Must be between 120-140 characters (strictly enforce this limit, DO NOT EXCEED 140 characters note that space is also a character including that it must not exceed 140 characters)
        3. ** prioritize the Description Must be of Maximum 140 characters or 2 very Short sentences . **
